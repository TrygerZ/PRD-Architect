    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-[var(--color-bg)] flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-[var(--color-surface)] border border-[var(--color-border)] rounded-md p-8 text-center">
            <div className="w-12 h-12 rounded-full bg-[var(--color-error)] flex items-center justify-center mx-auto mb-4">
            ...
            <button
              ...
              className="px-4 py-2 rounded-sm bg-[var(--color-text-primary)] text-[var(--color-bg)] text-sm font-medium hover:bg-[var(--color-text-primary)] transition-[color,transform] focus-visible:ring-2 focus-visible:ring-[var(--color-interactive)] focus-visible:outline-none active:scale-[0.97]"
