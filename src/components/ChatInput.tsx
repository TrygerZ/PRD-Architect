...
import { Send, Paperclip, Loader2, ShoppingCart, Smartphone, BarChart3, HeartPulse } from "lucide-react";
...
const quickPrompts = [
  { id: 1, label: "E-Commerce", text: "Buat PRD untuk aplikasi e-commerce yang menjual produk fashion lokal", icon: ShoppingCart },
  { id: 2, label: "Mobile POS", text: "Buat PRD untuk aplikasi POS mobile untuk UMKM", icon: Smartphone },
  { id: 3, label: "SaaS", text: "Buat PRD untuk dashboard analytics SaaS B2B", icon: BarChart3 },
  { id: 4, label: "HealthTech", text: "Buat PRD untuk aplikasi telemedicine", icon: HeartPulse },
];
